...
class Player(Entity):
    ...
    def input(self):
        ...
        if not self.attacking:
            ...
            # attack input
            if keys[pygame.K_SPACE] and self.ability_to_attack:
                self.attacking = True
            ...
            # magic input
            if keys[pygame.K_LCTRL] and self.ability_to_attack:
                style = list(magic_data)[self.magic_index]
                strength = list(magic_data.values())[self.magic_index]['strength'] + self.stats['magic']
                cost = list(magic_data.values())[self.magic_index]['cost']
                if not self.energy < cost:
                    self.attacking = True
                    self.attack_time = pygame.time.get_ticks()
